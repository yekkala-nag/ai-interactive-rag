      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        ...
        <div style={{ background: '#0f172a', border: '1px solid rgba(239, 68, 68, 0.3)', borderRadius: '10px', padding: '16px' }}>
          ...
          <div style={{ background: '#1e293b', padding: '14px', borderRadius: '8px', textAlign: 'center', marginBottom: '14px' }}>
            ...
            <div style={{ fontSize: '24px', fontWeight: 900, color: '#17837F' }}>▲ 85% SUCCESS</div>
        ...
        <div style={{ background: '#0f172a', border: '1px solid #2AB5B0', borderRadius: '10px', padding: '16px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <span style={{ fontSize: '12px', fontWeight: 'bold', color: '#17837F' }}>✅ MODERN AGENTOPS INSTRUMENTATION</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <div style={{ background: '#1e293b', padding: '10px', borderRadius: '6px', fontSize: '12px', borderLeft: '3px solid #2AB5B0' }}>
              <strong style={{ color: '#17837F' }}>1. pass^k Reliability:</strong> Measures consistency over k repeated runs rather than 1 lucky pass.
            </div>
            ...
            <div style={{ background: '#1e293b', padding: '10px', borderRadius: '6px', fontSize: '12px', borderLeft: '3px solid #2AB5B0' }}>
              <strong style={{ color: '#17837F' }}>3. Pre-Action Side-Effect Gates:</strong> Validates database writes, payments, and emails before execution.
            </div>
...
export function EarnedComplexityLadderDiagram() {
  const steps = [
    ...
    { lvl: 1, title: 'L1: Corpus Structure', badge: 'Clean Parsing', color: '#17837F', desc: 'Preserve tables, headers, and metadata before search.' },
    { lvl: 2, title: 'L2: BM25 Lexical', badge: 'Exact Codes', color: '#17837F', desc: 'Unbeatable for error codes (TS-999), SKUs, and citations.' },
    { lvl: 3, title: 'L3: Dense Vectors', badge: 'Paraphrases', color: '#17837F', desc: 'Overcomes vocabulary mismatch and semantic synonyms.' },
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '14px', marginBottom: '18px' }}>
        {/* Path 1: Direct */}
        <div style={{ background: 'rgba(16, 185, 129, 0.08)', border: '1px solid #2AB5B0', borderRadius: '8px', padding: '14px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
            <strong style={{ color: '#17837F', fontSize: '13px' }}>1. DIRECT MATCH</strong>
            <span style={{ color: '#17837F', fontWeight: 'bold', fontSize: '11px' }}>sim ≥ 0.92</span>
          </div>
        ...
        {/* Path 2: Adjacent */}
        <div style={{ background: 'rgba(56, 189, 248, 0.08)', border: '1px solid #2AB5B0', borderRadius: '8px', padding: '14px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
            <strong style={{ color: '#17837F', fontSize: '13px' }}>2. ADJACENT MATCH</strong>
            <span style={{ color: '#17837F', fontWeight: 'bold', fontSize: '11px' }}>0.78 ≤ sim &lt; 0.92</span>
          </div>
          <div style={{ fontSize: '12px', color: '#f8fafc', fontWeight: 'bold', marginBottom: '4px' }}>
      ...
      <div style={{ background: '#0b1120', border: '1px dashed #2AB5B0', borderRadius: '8px', padding: '12px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ fontSize: '12px', color: '#cbd5e1' }}>
        ...
        <span style={{ background: '#2AB5B0', color: '#000', fontWeight: 'bold', fontSize: '11px', padding: '4px 10px', borderRadius: '4px' }}>
...
export function NoisyTextStrategyForkDiagram() {
  return (
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        <div style={{ background: '#0f172a', border: '1px solid #2AB5B0', borderRadius: '10px', padding: '16px' }}>
          <div style={{ fontSize: '13px', fontWeight: 'bold', color: '#17837F', marginBottom: '8px' }}>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        {/* Layer 2 */}
        <div style={{ background: '#0f172a', borderLeft: '4px solid #2AB5B0', borderRadius: '6px', padding: '12px 16px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
            <span style={{ color: '#17837F', fontWeight: 'bold', fontSize: '13px' }}>LAYER 2: SEMANTIC & CROSS-FIELD VALIDATORS</span>
        ...
        <div style={{ background: '#0f172a', borderLeft: '4px solid #2AB5B0', borderRadius: '6px', padding: '12px 16px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
            <span style={{ color: '#17837F', fontWeight: 'bold', fontSize: '13px' }}>LAYER 1: SCHEMA & CONSTRAINED DECODING (THE FLOOR)</span>
