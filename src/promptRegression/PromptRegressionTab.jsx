...
export default function PromptRegressionTab() {
  ...
  return (
    <div style={{ paddingBottom: 'var(--ds-space-12)' }}>
      ...
      <Container size="wide">
        <div style={{ marginBottom: 'var(--ds-space-6)' }}><DiagramImage src="/assets/prompt_regression.svg" alt="Prompt regression pipeline" title="Golden → Diff → Canary → Citations → Rollback" caption="CI blocks merges; canary halts rollouts; rollback pins last-good and feeds the golden set." background="#090d16" maxWidth={1100} /></div>
