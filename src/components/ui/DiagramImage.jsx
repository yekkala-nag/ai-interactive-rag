        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <button onClick={reset} title="Reset" style={{ ...lb(64), fontFamily: "DM Mono, monospace", fontSize: "0.8rem", color: scale !== 1 ? "#C47A6A" : "#a0a5ba" }}>{Math.round(scale * 100)}%</button>
              <button onClick={zoomIn} title="Zoom In" style={lb(36)}>➕</button>
              <div style={{ width: 1, height: 24, background: "#3a3e54", margin: "0 6px" }} />
              <button onClick={close} title="Close" style={{ ...lb(80), background: "#C47A6A", border: "none", color: "#fff", fontWeight: 800 }}>✕ Close</button>
            </div>
          </div>
          <div
            onClick={(e) => e.stopPropagation()}
