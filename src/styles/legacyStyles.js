...
export const s = {
  ...
  sectionLabel: (color = "#F0A89A") => ({ fontFamily: "Syne, sans-serif", fontSize: "0.6rem", fontWeight: 700, letterSpacing: "0.25em", textTransform: "uppercase", color, borderLeft: `3px solid ${color}`, paddingLeft: "0.7rem", marginBottom: "1rem" }),
