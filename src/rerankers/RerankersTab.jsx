...
export default function RerankersTab() {
  ...
  return (
    <div style={{ paddingBottom: 'var(--ds-space-12)' }}>
      ...
      <Container size="wide">
        <div style={{ marginBottom: 'var(--ds-space-6)' }}><DiagramImage src="/assets/rerank_pipeline.svg" alt="Rerank pipeline" title="Bi-Only vs Cross-Encoder Rerank" caption="Same 6 candidates: bi-encoder buries truth at 4–6; rerank promotes to 1–3." background="#090d16" maxWidth={1100} /></div>
