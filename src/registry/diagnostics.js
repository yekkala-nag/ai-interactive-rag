...
export const ROLE_PATHS = {
  foundations: {
    ...
    icon: '🌱', color: '#5EC4C8', dark: '#1F6B6E', badgeVariant: 'module',
    goal: 'foundations',
  ...
  rag_specialist: {
    ...
    icon: '⚡', color: '#F0A89A', dark: '#C47A6A', badgeVariant: 'primary',
    goal: 'rag',
    children: [
      { child: 'fnd_prompts', max: 1 },
  ...
  agent_architect: {
    ...
    level: 'Advanced',
    icon: '🤖', color: '#9B89C4', dark: '#6B5E94', badgeVariant: 'accent',
    goal: 'agents',
    children: [
  ...
  enterprise_ops: {
    ...
    icon: '🏢', color: '#5EC4C8', dark: '#1F6B6E', badgeVariant: 'success',
    goal: 'enterprise',
    start: 'llmevals',
    children: [
      { child: 'fr_eval', max: 2 },
  ...
  data_engineer: {
    ...
    level: 'Intermediate',
    icon: '🗄️', color: '#F0A89A', dark: '#C47A6A', badgeVariant: 'module',
    goal: 'data',
    children: [
  ...
  full_mastery: {
    ...
    level: 'Comprehensive',
    icon: '👑', color: '#9B89C4', dark: '#6B5E94', badgeVariant: 'warning',
    goal: 'all',
    start: 'airoadmap',
...
export const JOURNEY_LOOPS = {
  ...
  journey_loop2: {
    ...
    level: 'Core journey',
    icon: '🧭', color: '#9B89C4', dark: '#6B5E94', badgeVariant: 'primary',
  ...
  journey_loop3: {
    ...
    level: 'Advanced',
    icon: '🏔️', color: '#F0A89A', dark: '#C47A6A', badgeVariant: 'warning',
