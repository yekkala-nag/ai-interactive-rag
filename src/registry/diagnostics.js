...
export const JOURNEY_LOOPS = {
  ...
  journey_loop2: {
    ...
    level: 'Core journey',
    icon: '🧭', color: '#2563eb', badgeVariant: 'primary',
    order: ['structuredoutputs', 'workflows', 'promptlearning', 'promptdependencygraph', 'unhobbling', 'modellandscape', 'quantserve', 'aiharness', 'posencoding', 'reinforcementlearning', 'trpo2grpo', 'aimoralagency', 'dialoguelamda', 'topicmodeling', 'ragcorpusshapes', 'hierrag', 'rerankers', 'rageval', 'rowlevelrag', 'tablegridrag', 'crossdocjoins', 'multilingualrag', 'multimodalrag', 'prodrag', 'routercheap', 'genpatterns', 'fourpdfs', 'agentfanout', 'ragcasestudies', 'interviewprep', 'hallucination', 'ctxmeasure', 'memhierarchy', 'contextgraph', 'companybrain', 'validitylayer', 'longcontext', 'agentplanner', 'agenthitl', 'agentsandbox', 'agentevals', 'handoffwatch', 'verifiedpipes', 'codingevals', 'agentdebugging', 'typedagentgate', 'multiagent', 'langchain', 'compare', 'mcpclient', 'cliagent', 'agentpairprogramming', 'vibecode', 'aiproductbuilder', 'docstruct', 'agenticparsing', 'knowledgebase', 'vectordbops', 'datapipeline', 'threelayers', 'frauddetectionml', 'timeseriesanomaly', 'vaes', 'byol', 'xlstm', 'keras3', 'aidataplat', 'medallionarch', 'aitestdatabottleneck', 'pythonprofiling', 'pythonengineering', 'functools', 'llmevals', 'modelvalidation', 'reasoningbench', 'guardrails', 'llmreliability', 'finops', 'productionragops', 'enterpriseaiops', 'enterprisegrade', 'observability', 'visionlanguage', 'diffusionmodels', 'speechvoice', 'slmedge', 'ragbeyond']
  },
  journey_loop3: {
