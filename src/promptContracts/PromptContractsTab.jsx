...
export default function PromptContractsTab() {
  ...
  return (
    <div style={{ paddingBottom: 'var(--ds-space-12)' }}>
      ...
      <Container size="wide">
        <div style={{ marginBottom: 'var(--ds-space-6)' }}><DiagramImage src="/assets/prompt_contracts.svg" alt="Prompt contracts" title="4 Parts → Compatible vs Breaking" caption="Reword/add-optional ships; rename/schema/caps widen blocks pending alias + major + re-eval." background="#090d16" maxWidth={1100} /></div>
