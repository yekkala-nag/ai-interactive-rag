...
export default function LongContextTab() {
  ...
  return (
    <div style={{ paddingBottom: 'var(--ds-space-12)' }}>
      ...
      <Container size="wide">
        <div style={{ marginBottom: 'var(--ds-space-6)' }}><DiagramImage src="/assets/long_context.svg" alt="Long context tactics" title="U-Curve + Anchors + Compression Ladder" caption="Double-anchor head/tail; L0–L3 compression; overflow triggers retrieve-then-read." background="#090d16" maxWidth={1100} /></div>
