                ...
                <Grid columns={{ base: '1fr', md: '1fr 1fr 1fr' }} gap="var(--ds-space-3)">
                  <Card style={{ padding: '16px', background: 'var(--ds-color-bg-surface)', borderTop: '4px solid #5EC4C8' }}>
                    <Flex justify="space-between" align="center" style={{ marginBottom: '8px' }}>
                      <strong style={{ fontSize: '13px', color: '#3A9B9F' }}>Stage 1: Vision Encoder (ViT)</strong>
                    ...
                    <div style={{ background: '#090d16', padding: '6px 10px', borderRadius: '4px', fontFamily: 'monospace', fontSize: '11px', color: '#3A9B9F' }}>
                  ...
                  <Card style={{ padding: '16px', background: 'var(--ds-color-bg-surface)', borderTop: '4px solid #5EC4C8' }}>
                    <Flex justify="space-between" align="center" style={{ marginBottom: '8px' }}>
                      <strong style={{ fontSize: '13px', color: '#3A9B9F' }}>Stage 2: Cross-Modal Connector</strong>
                ...
                <Grid columns={{ base: '1fr', md: '1fr 1fr' }} gap="var(--ds-space-4)">
                  <Card style={{ padding: '16px', background: '#090d16', border: '1px solid #5EC4C8' }}>
                    <Flex justify="space-between" align="center" style={{ marginBottom: '10px' }}>
                      <strong style={{ fontSize: '13px', color: '#3A9B9F' }}>TOTAL VISUAL TOKENS IN LLM CONTEXT:</strong>
              ...
              <Stack gap={4}>
                ...
                <Grid columns={{ base: '1fr', md: '1fr 1fr' }} gap="var(--ds-space-3)">
                  {VLM_CONNECTOR_ARCHITECTURES.map((conn) => (
                    <Card key={conn.id} style={{ padding: '16px', background: 'var(--ds-color-bg-surface)', borderLeft: '4px solid #5EC4C8' }}>
                      <Flex justify="space-between" align="center" style={{ marginBottom: '6px' }}>
                        <strong style={{ fontSize: '13px', color: '#3A9B9F' }}>{conn.name}</strong>
                        <Badge variant="outline">{conn.models}</Badge>
                      </Flex>

                      <div style={{ background: '#090d16', padding: '8px 12px', borderRadius: '4px', fontSize: '11px', color: '#3A9B9F', fontFamily: 'monospace', margin: '6px 0 8px 0' }}>
                        {conn.mechanism}
                      </div>
              ...
              <Stack gap={4}>
                ...
                <Grid columns={{ base: '1fr', md: '1fr 1fr' }} gap="var(--ds-space-4)">
                  <Card style={{ padding: '14px', background: 'var(--ds-color-bg-surface)', borderLeft: '4px solid #5EC4C8' }}>
                    ...
                    <div style={{ background: '#090d16', padding: '10px', borderRadius: '4px', color: '#3A9B9F', fontFamily: 'monospace', fontSize: '12px', marginBottom: '8px' }}>
                  ...
                  <Card style={{ padding: '14px', background: 'rgba(16,185,129,0.06)', border: '1px solid rgba(16,185,129,0.3)' }}>
                    <Flex justify="space-between" align="center" style={{ marginBottom: '8px' }}>
                      <strong style={{ fontSize: '12px', color: '#3A9B9F' }}>✅ VLM STRUCTURED RESPONSE</strong>
