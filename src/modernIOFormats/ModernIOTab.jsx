                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '11px', fontFamily: 'monospace' }}>
                    <thead>
                      <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                        ...
                        <th style={{ textAlign: 'center', padding: '8px', color: '#3A9B9F' }}>Read Time</th>
                        <th style={{ textAlign: 'center', padding: '8px', color: '#3A9B9F' }}>Write Time</th>
                        <th style={{ textAlign: 'center', padding: '8px', color: '#3A9B9F' }}>File Size</th>
                    ...
                    <tbody>
                      {IO_FORMATS_BENCHMARK.map((b, i) => (
                        <tr key={i} style={{ borderBottom: '1px solid rgba(255,255,255,0.03)', background: b.format.includes('DuckDB') || b.format.includes('Parquet') ? 'rgba(16,185,129,0.06)' : 'transparent' }}>
                          ...
                          <td style={{ padding: '8px', textAlign: 'center', color: b.readTimeSec > 5 ? '#ef4444' : '#5EC4C8', fontWeight: 'bold' }}>
                            {b.readTimeSec}s
                          </td>
                          <td style={{ padding: '8px', textAlign: 'center', color: '#3A9B9F' }}>{b.writeTimeSec}s</td>
                          <td style={{ padding: '8px', textAlign: 'center', color: '#3A9B9F' }}>{b.fileSizeMb} MB</td>
                          <td style={{ padding: '8px', textAlign: 'center', color: '#a78bfa' }}>{b.memoryUsageMb} MB</td>
                          <td style={{ padding: '8px', color: b.predicatePushdown.includes('Yes') ? '#5EC4C8' : '#ef4444' }}>
