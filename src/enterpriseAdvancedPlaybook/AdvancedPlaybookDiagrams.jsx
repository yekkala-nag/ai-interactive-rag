    ...
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '14px' }}>
        ...
        <div style={{ background: '#0f172a', border: '1px solid #5EC4C8', borderRadius: '10px', padding: '16px' }}>
          <span style={{ fontSize: '10px', background: 'rgba(56, 189, 248, 0.2)', color: '#3A9B9F', padding: '2px 6px', borderRadius: '4px', fontWeight: 'bold' }}>PATTERN A</span>
        ...
        {/* Pattern 2 */}
        <div style={{ background: '#0f172a', border: '1px solid #5EC4C8', borderRadius: '10px', padding: '16px' }}>
          <span style={{ fontSize: '10px', background: 'rgba(16, 185, 129, 0.2)', color: '#3A9B9F', padding: '2px 6px', borderRadius: '4px', fontWeight: 'bold' }}>PATTERN B</span>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
        {/* Layer 1 */}
        <div style={{ background: '#0f172a', borderLeft: '6px solid #5EC4C8', borderRadius: '8px', padding: '14px 18px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: '13px', fontWeight: 'bold', color: '#3A9B9F' }}>LAYER 1: BUSINESS METRICS</div>
          ...
          <span style={{ fontSize: '11px', background: 'rgba(16, 185, 129, 0.15)', color: '#3A9B9F', padding: '4px 10px', borderRadius: '6px', fontWeight: 'bold' }}>
        ...
        <div style={{ background: '#0f172a', borderLeft: '6px solid #5EC4C8', borderRadius: '8px', padding: '14px 18px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: '13px', fontWeight: 'bold', color: '#3A9B9F' }}>LAYER 2: APPLICATION METRICS</div>
            <div style={{ fontSize: '12px', color: '#cbd5e1' }}>P95 / P99 latency, requests per second (RPS), error rates, cache hit rate percentage</div>
          </div>
          <span style={{ fontSize: '11px', background: 'rgba(56, 189, 248, 0.15)', color: '#3A9B9F', padding: '4px 10px', borderRadius: '6px', fontWeight: 'bold' }}>
            Prometheus & Grafana
          </span>
        </div>
    ...
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 40px 1.2fr 40px 1.2fr', alignItems: 'center', gap: '8px', textAlign: 'center' }}>
        ...
        <div style={{ background: '#0f172a', border: '1px solid #5EC4C8', borderRadius: '8px', padding: '14px' }}>
          <div style={{ fontSize: '11px', color: '#3A9B9F', fontWeight: 'bold' }}>INGRESS TIER</div>
        ...
        <div style={{ fontSize: '18px', color: '#3A9B9F', fontWeight: 'bold' }}>➔</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          <div style={{ background: '#0f172a', border: '1px solid #5EC4C8', borderRadius: '8px', padding: '8px', fontSize: '11px' }}>
            <strong style={{ color: '#3A9B9F' }}>Redis Cluster Cache</strong>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          <div style={{ background: '#0f172a', border: '1px solid #5EC4C8', borderRadius: '8px', padding: '8px', fontSize: '11px' }}>
            <strong style={{ color: '#3A9B9F' }}>Distributed Workloads</strong>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '14px' }}>
        {/* Stage 1 */}
        <div style={{ background: '#0f172a', border: '1px solid #5EC4C8', borderRadius: '10px', padding: '16px' }}>
          <span style={{ fontSize: '10px', background: 'rgba(56, 189, 248, 0.2)', color: '#3A9B9F', padding: '2px 6px', borderRadius: '4px', fontWeight: 'bold' }}>STAGE 1</span>
        ...
        {/* Stage 3 */}
        <div style={{ background: '#0f172a', border: '1px solid #5EC4C8', borderRadius: '10px', padding: '16px' }}>
          <span style={{ fontSize: '10px', background: 'rgba(16, 185, 129, 0.2)', color: '#3A9B9F', padding: '2px 6px', borderRadius: '4px', fontWeight: 'bold' }}>STAGE 3</span>
...
export function StackAdaptationComparisonDiagram() {
  return (
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '14px' }}>
        <div style={{ background: '#0f172a', border: '1px solid #5EC4C8', borderRadius: '10px', padding: '16px' }}>
          <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#3A9B9F' }}>PYTHON ECOSYSTEM</div>
        ...
        <div style={{ background: '#0f172a', border: '1px solid #5EC4C8', borderRadius: '10px', padding: '16px' }}>
          <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#3A9B9F' }}>JAVA / SPRING AI</div>
