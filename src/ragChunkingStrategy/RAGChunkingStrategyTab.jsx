          ...
          <Stack gap={6}>
            <Card style={{ padding: 'var(--ds-space-5)', background: 'var(--ds-color-bg-canvas)' }}>
              <Stack gap={4}>
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          border: `1px solid ${isCurrent ? '#5EC4C8' : 'var(--ds-color-border-subtle)'}`,
                          borderRadius: 'var(--ds-radius-md)',
                          padding: '10px 8px',
                ...
                <Card style={{ padding: 'var(--ds-space-5)', background: 'var(--ds-color-bg-surface)', borderLeft: '4px solid #5EC4C8' }}>
                  <Stack gap={3}>
                    <Flex justify="space-between" align="center" style={{ flexWrap: 'wrap', gap: '8px' }}>
                      <Flex gap="var(--ds-space-2)" align="center">
                        <span style={{ fontSize: '24px' }}>{activePipelineStep.icon}</span>
                        <div>
                          <strong style={{ fontSize: '16px', color: '#3A9B9F' }}>
                    ...
                    <Grid columns={{ base: '1fr', md: '1fr 1fr' }} gap="var(--ds-space-3)">
                      ...
                      <div style={{ background: '#090d16', padding: '12px', borderRadius: '6px', border: '1px solid var(--ds-color-border-subtle)' }}>
                        <strong style={{ fontSize: '11px', color: '#3A9B9F', display: 'block', marginBottom: '6px' }}>
              ...
              <Stack gap={4}>
                ...
                <Grid columns={{ base: '1fr', md: '1fr 1fr 1fr' }} gap="var(--ds-space-3)">
                  <Card style={{ padding: '12px', background: 'var(--ds-color-bg-surface)' }}>
                    <label style={{ fontSize: '11px', color: '#3A9B9F', fontWeight: 'bold', display: 'block', marginBottom: '6px' }}>
                  ...
                  <Card style={{ padding: '12px', background: 'var(--ds-color-bg-surface)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11px', marginBottom: '4px' }}>
                      <span style={{ color: '#3A9B9F', fontWeight: 'bold' }}>TARGET CHUNK SIZE:</span>
                    ...
                    <input
                      ...
                      style={{ width: '100%', accentColor: '#5EC4C8', marginBottom: '8px' }}
                    />
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11px', marginBottom: '4px' }}>
                ...
                {simResult && (
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '18px', fontWeight: 'bold', color: '#3A9B9F' }}>{simResult.retrievalPrecision}</div>
                    </div>
                    <div>
                      <div style={{ fontSize: '10px', color: 'var(--ds-color-text-tertiary)' }}>SEMANTIC INTEGRITY</div>
                      <div style={{ fontSize: '18px', fontWeight: 'bold', color: simResult.semanticQuality === 'Poor' ? '#ef4444' : '#5EC4C8' }}>
                        {simResult.semanticQuality}
                      </div>
                    </div>
                    <div>
                      <div style={{ fontSize: '10px', color: 'var(--ds-color-text-tertiary)' }}>SEVERED SENTENCES</div>
                      <div style={{ fontSize: '18px', fontWeight: 'bold', color: simResult.severedSentencesCount > 0 ? '#ef4444' : '#5EC4C8' }}>
                        {simResult.severedSentencesCount} cuts
                      </div>
                    </div>
                    <div>
                      <div style={{ fontSize: '10px', color: 'var(--ds-color-text-tertiary)' }}>CONTEXT RETENTION</div>
                      <div style={{ fontSize: '18px', fontWeight: 'bold', color: '#3A9B9F' }}>{simResult.contextRetention}</div>
                    </div>
                  </div>
                )}
                      ...
                      {simResult.chunks.map((chunk) => (
                        <div
                          ...
                          style={{
                            ...
                            borderLeft: `4px solid ${chunk.breaksMidSentence ? '#ef4444' : '#5EC4C8'}`,
                            borderRadius: '6px',
                            padding: '12px',
                            cursor: 'pointer',
                        ...
                        >
                          <Flex justify="space-between" align="center" style={{ marginBottom: '6px' }}>
                            <Flex gap="var(--ds-space-2)" align="center">
                              <span style={{ fontSize: '11px', fontWeight: 'bold', color: '#3A9B9F' }}>
                                Chunk #{chunk.id}
                              </span>
                            ...
                            <Flex gap="var(--ds-space-2)">
                              {chunk.breaksMidSentence ? (
                                ...
                                <Badge variant="subtle" style={{ background: 'rgba(16,185,129,0.2)', color: '#3A9B9F', fontSize: '9px' }}>
                                  ✓ BOUNDARY CLEAN
                                </Badge>
                              )}
                            </Flex>
            ...
            <Card style={{ padding: 'var(--ds-space-5)', background: 'var(--ds-color-bg-canvas)' }}>
              <Stack gap={4}>
                ...
                <Card style={{ padding: 'var(--ds-space-5)', background: 'var(--ds-color-bg-surface)' }}>
                  <Stack gap={4}>
                    <div>
                      <div style={{ fontSize: '11px', color: '#3A9B9F', fontWeight: 'bold', textTransform: 'uppercase' }}>
                    ...
                    <Grid columns={{ base: '1fr', md: '1fr 1fr' }} gap="var(--ds-space-4)">
                      ...
                      <Card style={{ padding: '14px', background: '#0d1f1a', border: '1px solid rgba(16,185,129,0.4)', borderTop: '4px solid #5EC4C8' }}>
                        <Stack gap={2}>
                          <Flex justify="space-between" align="center">
                            <strong style={{ fontSize: '12px', color: '#3A9B9F' }}>
...
Give a short 1-2 sentence context to situate this chunk for search.`}
                  ...
                  <Card style={{ padding: '16px', background: 'var(--ds-color-bg-surface)', borderTop: '4px solid #5EC4C8' }}>
                    <Stack gap={3}>
                      <Flex justify="space-between" align="center">
                        <strong style={{ fontSize: '14px', color: '#3A9B9F' }}>
                          ⏳ Jina Late Chunking
                        </strong>
                        <Badge variant="subtle" style={{ background: 'rgba(56,189,248,0.2)', color: '#3A9B9F', fontSize: '10px' }}>
                          Attention Pooling
                        </Badge>
                      </Flex>
                      <p style={{ fontSize: '12px', color: 'var(--ds-color-text-secondary)', margin: 0 }}>
                      ...
                      <div style={{ background: '#090d16', padding: '12px', borderRadius: '6px', border: '1px solid var(--ds-color-border-subtle)' }}>
                        <div style={{ fontSize: '10px', color: '#3A9B9F', fontWeight: 'bold', marginBottom: '4px' }}>
            ...
            <Card style={{ padding: 'var(--ds-space-5)', background: 'var(--ds-color-bg-canvas)' }}>
              <Stack gap={4}>
                ...
                <Grid columns={{ base: '1fr', md: '1fr 1fr 1fr' }} gap="var(--ds-space-4)">
                  ...
                  <Card style={{ padding: '14px', background: 'var(--ds-color-bg-surface)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11px', marginBottom: '4px' }}>
                      <span style={{ color: '#3A9B9F', fontWeight: 'bold' }}>DOC VOLUME:</span>
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#3A9B9F' }}>{recommendedChunkTokens} tokens</div>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#3A9B9F' }}>${monthlyCostEst}</div>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
                    <thead>
                      <tr style={{ borderBottom: '2px solid var(--ds-color-border-subtle)' }}>
                        <th style={{ padding: '10px', textAlign: 'left', color: '#3A9B9F' }}>Strategy</th>
                    ...
                    <tbody>
                      {CHUNKING_COMPARISON_TABLE.map((row, idx) => (
                        <tr key={idx} style={{ borderBottom: '1px solid var(--ds-color-border-subtle)' }}>
                          ...
                          <td style={{ padding: '10px', textAlign: 'center', color: row.speed.includes('1x') ? '#5EC4C8' : row.speed.includes('2x') || row.speed.includes('4x') ? '#f59e0b' : '#ef4444' }}>
                            {row.speed}
                          </td>
                          <td style={{ padding: '10px', textAlign: 'center', color: Number(row.quality.replace('%','')) > 85 ? '#5EC4C8' : Number(row.quality.replace('%','')) > 60 ? '#5EC4C8' : '#ef4444', fontWeight: 'bold' }}>
                            {row.quality}
                          </td>
