              ...
              <Stack gap={4}>
                ...
                <Card style={{ padding: '16px', background: 'var(--ds-color-bg-surface)' }}>
                  <Flex justify="space-between" align="center" style={{ marginBottom: '8px' }}>
                    ...
                    <Badge variant="subtle" style={{ color: currentTimestep > 500 ? '#ef4444' : '#5EC4C8', background: currentTimestep > 500 ? 'rgba(239,68,68,0.15)' : 'rgba(16,185,129,0.15)' }}>
                ...
                <Grid columns={{ base: '1fr', md: '1fr 1fr' }} gap="var(--ds-space-4)">
                  <Card style={{ padding: '16px', background: '#090d16', border: '1px solid #5EC4C8', textAlign: 'center' }}>
                    ...
                    <div
                      style={{
                        ...
                        background: currentTimestep > 800
                          ...
                          : 'linear-gradient(135deg, #5EC4C8, #5EC4C8)',
              ...
              <Stack gap={4}>
                ...
                <Grid columns={{ base: '1fr', md: '1fr 1fr' }} gap="var(--ds-space-3)">
                  {DIFFUSION_ARCHITECTURAL_PARADIGMS.map((par) => (
                    <Card key={par.id} style={{ padding: '16px', background: 'var(--ds-color-bg-surface)', borderLeft: '4px solid #5EC4C8' }}>
                      <Flex justify="space-between" align="center" style={{ marginBottom: '6px' }}>
                        <strong style={{ fontSize: '13px', color: '#3A9B9F' }}>{par.name}</strong>
                      </Flex>
                      ...
                      <div style={{ background: '#090d16', padding: '6px 10px', borderRadius: '4px', fontSize: '11px', fontFamily: 'monospace', color: '#3A9B9F', marginBottom: '8px' }}>
                ...
                <Grid columns={{ base: '1fr', md: '1fr 1fr' }} gap="var(--ds-space-4)">
                  <Card style={{ padding: '14px', background: '#090d16', border: '1px solid #F5A623' }}>
                    ...
                    <div style={{ fontFamily: 'monospace', fontSize: '12px', color: 'white', lineHeight: '1.8' }}>
                      ...
                      <span style={{ color: '#3A9B9F', fontWeight: 'bold' }}>Final Extrapolated Score: {cfgResult.guidedScore}</span>
                    </div>
                  </Card>
          ...
          <Stack gap={6}>
            <Card style={{ padding: 'var(--ds-space-5)', background: 'var(--ds-color-bg-canvas)' }}>
              <Stack gap={4}>
                ...
                <Stack gap={3}>
                  <Card style={{ padding: '14px', background: 'var(--ds-color-bg-surface)', borderLeft: '4px solid #5EC4C8' }}>
                    <strong style={{ fontSize: '13px', color: '#3A9B9F' }}>1. Forward Diffusion Markov Chain (Closed-Form Sampling)</strong>
                  ...
                  <Card style={{ padding: '14px', background: 'var(--ds-color-bg-surface)', borderLeft: '4px solid #5EC4C8' }}>
                    <strong style={{ fontSize: '13px', color: '#3A9B9F' }}>2. Simplified Denoising Training Objective (L_simple)</strong>
                    <div style={{ padding: '8px 12px', background: '#090d16', color: '#3A9B9F', fontFamily: 'monospace', fontSize: '12px', margin: '6px 0' }}>
